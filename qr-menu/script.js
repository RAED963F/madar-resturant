    ...
    },
    {
      ...
      items: [

        {
          ...
          desc: {
            ar: 'ليمون طازج مع ماء بارد ومنعش',
            en: 'Fresh lemon with chilled water',
...

        {
          ...
          desc: {
            ar: 'عصير طبيعي غني بالفيتامينات',
            en: 'Natural juice rich in vitamins',
...

        {
          ...
          desc: {
            ar: 'مزيج منعش من الفواكه الطازجة',
            en: 'Refreshing fruit blend',
...

        {
          ...
          desc: {
            ar: 'تشكيلة من المشروبات الغازية الباردة',
            en: 'Selection of chilled soft drinks',
...

        {
          ...
          desc: {
            ar: 'عصير توت طبيعي منعش',
            en: 'Refreshing natural berry drink',
...

        {
          ...
          desc: {
            ar: 'مزيج من الفواكه مع النعناع لتنقية الجسم',
            en: 'Fruit mix with mint for detox',
